<template>
  <div v-if="easyFlowVisible" style="height: calc(100vh);" @click="handleCloseContextMenu">
    <el-row>
      <!--顶部工具菜单-->
      <el-col :span="24">
    ...
    <div style="display: flex;height: calc(100% - 47px);">
      ...
      <!--            :visible.sync=drawer-->
      <!--          >-->
      <div style="width: 200px;border-left: 1px solid #dce3e8;background-color: #FBFBFB">
